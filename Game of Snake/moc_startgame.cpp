...
void startgame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        startgame *_t = static_cast<startgame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->quitg(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject startgame::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_startgame.data,
      qt_meta_data_startgame,  qt_static_metacall, nullptr, nullptr}
};
